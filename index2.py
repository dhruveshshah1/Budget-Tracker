...
def Database():
    ...
    cursor.execute("CREATE TABLE IF NOT EXISTS curbudget (product_id INTEGER , cur_budget INTEGER)")
...
def BudgetForm():
    ...
    cursor.execute("INSERT INTO curbudget(product_id,cur_budget) VALUES(?,?)",(1,BUD_GET.get()))
...
def graph_data():
    ...
    cursor.execute('SELECT product_name,product_qty FROM product')
